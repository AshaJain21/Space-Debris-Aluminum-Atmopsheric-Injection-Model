function [rastered_surface] = hista_defineEqualAreaBins(lat, lon, binareasize)
...
binAreaInSquareKilometers = binareasize; 
angleUnit = 'degrees';
...
% Define the rastered surface
[rastered_surface] = eqabin(lat, lon, binAreaInSquareKilometers, spheroid);


%-----------------------------------------------------------------------

function [rastered_surface] ...
...
if isempty(lat)
    ...
    rastered_surface = rasterReferenceInEqualAreaSystem(x, y, cellwidth);
